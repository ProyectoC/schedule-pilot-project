package com.schedulepilot.core.email.service.imp;
...
public class EmailServiceImp implements EmailService {
    ...
    @Async
    @Override
    @Retryable(value = {SchedulePilotException.class}, maxAttempts = 3, backoff = @Backoff(5000))
    public void sendEmail(EmailProperties emailProperties, EmailDto emailDto) throws SchedulePilotException {
        try {
            ...
            throw new SchedulePilotException(ExceptionCode.ERROR_SEND_EMAIL, ex);
        }
    }

    @Recover
    public void sendEmailRecovery(SchedulePilotException t, EmailProperties emailProperties, EmailDto emailDto) {
